...
## How To Demo (Summary)
- Generate `.eml` messages: `python tools/email_generator.py --out-dir data/demo_inbox --count 20`
- Ingest to queue: `python tools/email_ingest.py --folder data/demo_inbox --queue data/email_queue.xlsx --watch`
